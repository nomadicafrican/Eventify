...
>
	{#each data.events as event}
		<div class="h-full w-full rounded-lg bg-white p-8 shadow-lg hover:bg-gray-100">
			<ul class="h-max w-full">
				<li><h2 style="font-size: 24px; font-weight: 400;">{event.name}</h2></li>
				<li>Min attendees: {event.min_attendees}</li>
				<li>Max attendees: {event.max_attendees}</li>
